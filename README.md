...
Al principio tenía contenteditable="true" en todo el post-it, pero esto causaba que podía eliminar el botón de borrar sin querer. Para arreglar esto, dividí el post-it en dos, un textarea .contenido que es editable y el botón que no lo es. Esto arregló el problema del todo. Parecido a este problema, al hacer que los post-its se pudieran mover me di cuenta de que no era fácil saber dónde había que hacer click para arrastrarlos. Por eso añadí una sección .agarre en la parte superior, que es la única zona que activa el arrastre.
